...
var app = (function () {
    ...
    const file$9 = "src\\components\\NavItems.svelte";
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(nav, file$9, 5, 0, 109);
    		},
    ...
    function instance$9($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ slide, quintOut });
    	return [];
    }
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$8, 20, 8, 534);
    			add_location(button, file$8, 19, 6, 471);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(25:2) {#if $menuToggle && show === false}",
    		ctx
    	});
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$8, 13, 4, 326);
    			add_location(div0, file$8, 12, 2, 316);
    			add_location(div1, file$8, 15, 2, 413);
    			attr_dev(header, "class", "relative z-50 flex justify-between items-center py-5 border-b border-white");
    			add_location(header, file$8, 9, 0, 219);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$6 = "src\\components\\WhatIDo.svelte";
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$6, 5, 4, 109);
    			add_location(div0, file$6, 4, 2, 99);
    			attr_dev(p0, "class", "text-xl md:text-2xl font-medium");
    			add_location(p0, file$6, 8, 4, 167);
    			add_location(p1, file$6, 13, 6, 441);
    			add_location(p2, file$6, 17, 6, 601);
    			attr_dev(div1, "class", "columns-1 md:columns-2 space-y-5 md:space-x-10");
    			add_location(div1, file$6, 12, 4, 374);
    			attr_dev(div2, "class", "space-y-8");
    			add_location(div2, file$6, 7, 2, 139);
    ...
    */
    ...
    const file$4 = "src\\components\\projects\\Demos.svelte";
    ...
    function create_catch_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$4, 44, 4, 1451);
    		},
    		m: function mount(target, anchor) {
    ...
    // (20:10) {#each project.stack as item}
    function create_each_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(t_value);
    			attr_dev(li, "class", "");
    			add_location(li, file$4, 20, 12, 717);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*$response*/ 1 && t_value !== (t_value = /*item*/ ctx[6] + "")) set_data_dev(t, t_value);
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(20:10) {#each project.stack as item}",
    		ctx
    	});
    ...
    function create_each_block$1(ctx) {
    	...
    	let a1_href_value;
    	let t8;
    	let each_value_1 = /*project*/ ctx[3].stack;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h4, file$4, 14, 8, 451);
    			attr_dev(p, "class", "text-sm text-neutral-300");
    			add_location(p, file$4, 15, 8, 502);
    			attr_dev(ul, "class", "flex flex-wrap gap-y-1 gap-x-2 text-xs list-disc list-inside");
    			add_location(ul, file$4, 16, 8, 572);
    			attr_dev(i0, "class", "fas fa-external-link-alt");
    			add_location(i0, file$4, 30, 12, 1047);
    			attr_dev(a0, "href", a0_href_value = /*project*/ ctx[3].liveUrl);
    			attr_dev(a0, "target", "_blank");
    			attr_dev(a0, "rel", "noopener noreferrer");
    			attr_dev(a0, "class", "border-b border-white hover:text-primary hover:border-primary");
    			add_location(a0, file$4, 24, 10, 826);
    			attr_dev(i1, "class", "fas fa-external-link-alt");
    			add_location(i1, file$4, 38, 12, 1336);
    			attr_dev(a1, "href", a1_href_value = /*project*/ ctx[3].sourceUrl);
    			attr_dev(a1, "target", "_blank");
    			attr_dev(a1, "rel", "noopener noreferrer");
    			attr_dev(a1, "class", "border-b border-white hover:text-primary hover:border-primary");
    			add_location(a1, file$4, 32, 10, 1111);
    			attr_dev(div0, "class", "flex gap-4 text-sm");
    			add_location(div0, file$4, 23, 8, 783);
    			attr_dev(div1, "class", "p-5 bg-neutral-800 space-y-4");
    			add_location(div1, file$4, 13, 6, 400);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*$response*/ 1 && t0_value !== (t0_value = /*project*/ ctx[3].title + "")) set_data_dev(t0, t0_value);
    			if (dirty & /*$response*/ 1 && t2_value !== (t2_value = /*project*/ ctx[3].description + "")) set_data_dev(t2, t2_value);

    			if (dirty & /*$response*/ 1) {
    				each_value_1 = /*project*/ ctx[3].stack;
    				validate_each_argument(each_value_1);
    				let i;
    			...
    			if (dirty & /*$response*/ 1 && a0_href_value !== (a0_href_value = /*project*/ ctx[3].liveUrl)) {
    				attr_dev(a0, "href", a0_href_value);
    			}

    			if (dirty & /*$response*/ 1 && a1_href_value !== (a1_href_value = /*project*/ ctx[3].sourceUrl)) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(13:4) {#each data as project}",
    		ctx
    	});
    ...
    function create_pending_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$4, 10, 4, 336);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "pending",
    		source: "(10:20)      <p>Loading</p>   {:then data}",
    		ctx
    	});
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$4, 8, 0, 266);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ getData, query: query$1, response, $response });
    ...
    const file$3 = "src\\components\\projects\\Webs.svelte";
    ...
    function create_catch_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			p = element("p");
    			p.textContent = "Ups something went wrong";
    			add_location(p, file$3, 44, 4, 1465);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(t_value);
    			attr_dev(li, "class", "");
    			add_location(li, file$3, 20, 12, 731);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, li, anchor);
    			append_dev(li, t);
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t8 = space();
    			attr_dev(h4, "class", "uppercase");
    			add_location(h4, file$3, 14, 8, 465);
    			attr_dev(p, "class", "text-sm text-neutral-300");
    			add_location(p, file$3, 15, 8, 516);
    			attr_dev(ul, "class", "flex flex-wrap gap-y-1 gap-x-2 text-xs list-disc list-inside");
    			add_location(ul, file$3, 16, 8, 586);
    			attr_dev(i0, "class", "fas fa-external-link-alt");
    			add_location(i0, file$3, 30, 12, 1061);
    			attr_dev(a0, "href", a0_href_value = /*project*/ ctx[3].liveUrl);
    			attr_dev(a0, "target", "_blank");
    			attr_dev(a0, "rel", "noopener noreferrer");
    			attr_dev(a0, "class", "border-b border-white hover:text-primary hover:border-primary");
    			add_location(a0, file$3, 24, 10, 840);
    			attr_dev(i1, "class", "fas fa-external-link-alt");
    			add_location(i1, file$3, 38, 12, 1350);
    			attr_dev(a1, "href", a1_href_value = /*project*/ ctx[3].sourceUrl);
    			attr_dev(a1, "target", "_blank");
    			attr_dev(a1, "rel", "noopener noreferrer");
    			attr_dev(a1, "class", "border-b border-white hover:text-primary hover:border-primary");
    			add_location(a1, file$3, 32, 10, 1125);
    			attr_dev(div0, "class", "flex gap-4 text-sm");
    			add_location(div0, file$3, 23, 8, 797);
    			attr_dev(div1, "class", "p-5 bg-neutral-800 space-y-4");
    			add_location(div1, file$3, 13, 6, 414);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div1, anchor);
    			append_dev(div1, h4);
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			info.block.c();
    			attr_dev(div, "class", "grid lg:grid-cols-2 gap-5 my-5");
    			add_location(div, file$3, 8, 0, 280);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ getData, query, response, $response });
    	return [$response, response];
    }
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$2, 10, 4, 214);
    			add_location(div0, file$2, 9, 2, 204);
    			attr_dev(h30, "class", "border-b border-dashed");
    			add_location(h30, file$2, 15, 6, 287);
    			add_location(div1, file$2, 14, 4, 275);
    			attr_dev(h31, "class", "border-b border-dashed");
    			add_location(h31, file$2, 20, 6, 408);
    			add_location(div2, file$2, 19, 4, 396);
    			add_location(div3, file$2, 12, 2, 243);
    			attr_dev(section, "id", "projects");
    			attr_dev(section, "class", "grid md:grid-cols-[120px_1fr] gap-10 md:gap-20 py-20");
    			add_location(section, file$2, 5, 0, 112);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$1, 4, 2, 96);
    			attr_dev(h4, "class", "text-xl");
    			add_location(h4, file$1, 6, 4, 192);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file, 11, 2, 400);
    			attr_dev(div, "class", "w-11/12 md:w-9/12 max-w-screen-xl m-auto");
    			add_location(div, file, 9, 0, 330);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
